public class Constants {
    public static final int BMI_PANEL_WIDTH= 2000;
    public static final int  BMI_PANEL_HEIGHT= 1000;
    public static final int PERSON_DATA_PANEL_WIDTH=500;
    public static final int PERSON_DATA_PANEL_HEIGHT=250;
    public static final int TEXT_FILED_COLUMNS=40;
    public static final int GENDER_PANEL_WIDTH = 500;
    public static final int GENDER_PANEL_HEIGHT = 400;
    public static final int USER_HEIGHT_PANEL_WIDTH=700;
    ...
    public static final int USER_WEIGHT_PANEL_WIDTH=400;
    public static final int USER_WEIGHT_PANEL_HEIGHT= 400;
